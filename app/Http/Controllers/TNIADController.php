...
class TNIADController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menubar.tniad', compact('frekuensi', 'divisiCode'));       
    }
    ...
    public function create()
    {
        $frekuensi = Frekuensi::all();
        $divisiCode = Frekuensi::where('divisi_code', 2)->first();
        return view('layout.tniadStore', compact('frekuensi', 'divisiCode'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tniad.index')->with('message', 'Data created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('layout.tniadEdit', compact('frekuensi'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('tniad.index')->with('message', 'Data updated successfully.');
    }
    ...
    public function destroy(Frekuensi $id)
    {
        ...
        return redirect()->route('tniad.index')
