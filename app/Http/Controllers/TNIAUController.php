...
class TNIAUController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menubar.tniau', compact('frekuensi', 'divisiCode'));       
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tniau.index')->with('message', 'Data created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('tniau.index')->with('message', 'Data updated successfully.');
    }
    ...
    public function destroy(Frekuensi $id)
    {
        ...
        return redirect()->route('tniau.index')
