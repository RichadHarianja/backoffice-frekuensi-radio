...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('mabestni.update', $frekuensi->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="type_code" class="form-label">JENIS FREKUENSI:</label>
                        <select class="form-select @error('type_code') is-invalid @enderror" id="type_code" name="type_code" value="{{ $frekuensi->type_code }}">
                                <option value="{{ $frekuensi->type_code }}">{{ $frekuensi->type_code }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('type') is-invalid @enderror" id="type" name="type" value="{{ $frekuensi->type }}">
                                <option value="{{ $frekuensi->type }}">{{ $frekuensi->type }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('service') is-invalid @enderror" id="service" name="service" value="{{ $frekuensi->service }}">
                                <option value="{{ $frekuensi->service }}">{{ $frekuensi->service }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror"  id="status" name="status" value="{{ $frekuensi->status }}">
                                <option value="{{ $frekuensi->status }}">{{ $frekuensi->status }}</option>
